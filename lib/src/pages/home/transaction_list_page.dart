...
import 'package:money_track/src/components/widgets/transaction_group_separator.dart';
...
class _TransactionListPageState extends State<TransactionListPage> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      var transactionList = await _transactionService
          .getLast(Paging(currentPage: _currentPage, pageSize: _pageSize));
    ...
    return Scaffold(
      body: GroupedListView<TransactionModel, DateTime>(
          ...
          groupSeparatorBuilder: (DateTime date) =>
              TransactionGroupSeparator(date),
                        ...
                        return Container(
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              children: <Widget>[
                                AddTransactionForm(
                                    key: _formKey, model: transaction),
                                Row(
                                  mainAxisAlignment:
                                  ...
                                  children: <Widget>[
                                    ElevatedButton(
                                      ...
                                      onPressed: () async {
                                        var transaction = _formKey.currentState
                                            ?.getTransaction();
                      ...
                      ListTile(
                        ...
                        trailing: Text(
                          ...
                          style: TextStyle(
                              ...
                              color: transaction.quantity > Decimal.zero
                                  ? Colors.green
                                  : Colors.black),
                        ),
                      ),
  ...
  void _scrollListener() {
    if ((_controller.position.extentAfter < 500 &&
            _controller.position.extentAfter >= prevExtentAfter) ||
        _controller.position.extentAfter < 300) {
      prevExtentAfter = _controller.position.extentAfter;

      var newPage = _currentPage + 1;
      var newItems = _transactionService
          .getLast(Paging(currentPage: newPage, pageSize: _pageSize));
